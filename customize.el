(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csharp-mode omnisharp helm-dash elixir-mode diminish prettier-js-mode elm-mode markdown-mode stylus-mode scss-mode prettier-js add-node-modules-path helm-core yasnippet-snippets helm-projectile helm-flycheck helm-ag helm-swoop helm-descbinds helm shader-mode color-theme-sanityinc-tomorrow json-mode unbind-key tide-mode tide js2-mode yasnippet projectile multiple-cursors smartparens magit zenburn-theme zen-burn exec-path-from-shell emmet-mode default-text-scale yaml-mode whitespace-cleanup-mode which-key web-mode use-package typescript-mode slim-mode sass-mode rubocop rspec-mode rbenv rainbow-mode rainbow-delimiters persp-projectile page-break-lines overseer macrostep karma js2-refactor ibuffer-projectile highlight-numbers f evil-smartparens erlang enh-ruby-mode elisp-slime-nav drag-stuff company cask-mode beacon ag)))
